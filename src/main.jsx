...
const basePlayers = [
  ...
  { number: null, positionGroup: "FW", position: "ST", subPositions: [], firstName: "Emil", lastName: "Højlund", displayName: "Emil Højlund", image: "", age: 23, overall: 74, preferredFoot: "右", wage: "€1,300", nationality: "デンマーク", status: "On Loan", note: "レンタル移籍 / 旧背番号9", role: "武者修行中のCF", bio: "ポストプレーと連係に可能性を持つストライカー。レンタル先で得点感覚と自信を磨きたい。" },
