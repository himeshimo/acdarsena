...
const players = [
  ...
  { number: 27, positionGroup: "FW", position: "RW", subPositions: ["CAM", "CM", "RM"], firstName: "Matheus", lastName: "Mané", displayName: "Matheus Mané", image: "./players/matheus-mane.webp", age: 20, overall: 75, preferredFoot: "右", wage: "€7,000", nationality: "イングランド", status: "Prospect", note: "", role: "攻撃の変化球", bio: "右サイド、中央、インサイドでプレーできる若手。試合にリズムの変化を加えられる存在。" },
