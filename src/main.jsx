...
const players = [
  { number: 1, positionGroup: "GK", position: "GK", subPositions: [], firstName: "Elia", lastName: "Caprile", displayName: "Elia Caprile", image: "./players/caprile.png", age: 26, overall: 82, preferredFoot: "右", wage: "€21,500", nationality: "イタリア", status: "Squad", note: "", role: "守備文化の基準点", bio: "Darsenaの最後方を支える正GK。派手な主役ではなく、チーム全体に落ち着きと信頼を与える存在。" },
  { number: 2, positionGroup: "DF", position: "CB", subPositions: ["RB", "CDM"], firstName: "Enrico", lastName: "Delprato", displayName: "Enrico Delprato", image: "./players/delprato.png", age: 28, overall: 78, preferredFoot: "右", wage: "€21,000", nationality: "イタリア", status: "Summer Signing", note: "夏加入", role: "実直な新戦力", bio: "CB、RB、CDMをこなす万能DF。夏加入組らしく、Darsenaの守備構造に厚みを加える。" },
  { number: 3, positionGroup: "DF", position: "CB", subPositions: ["CM"], firstName: "Andrea", lastName: "Guidi", displayName: "Andrea Guidi", image: "./players/guidi.png", age: 34, overall: 74, preferredFoot: "右", wage: "€16,000", nationality: "イタリア", status: "Captain", note: "", role: "The Soul", bio: "Not measured by minutes or ratings. He carries Darsena's history and culture." },
  { number: 4, positionGroup: "DF", position: "LB", subPositions: ["LM", "CM"], firstName: "Alexander", lastName: "Prass", displayName: "Alexander Prass", image: "./players/alexander-prass.png", age: 26, overall: 78, preferredFoot: "左", wage: "€22,000", nationality: "オーストリア", status: "Squad", note: "", role: "左の前進装置", bio: "LBから中盤までこなす左利きのマルチロール。守備だけでなく、攻撃の出口としても機能する。" },
  { number: 6, positionGroup: "MF", position: "CDM", subPositions: ["CB"], firstName: "Gabriele", lastName: "Monti", displayName: "Gabriele Monti", image: "./players/gabriele-monti.png", age: 30, overall: 70, preferredFoot: "右", wage: "€8,000", nationality: "イタリア", status: "Squad", note: "", role: "守備の締め役", bio: "派手さはないが、試合を閉じるために必要な選手。ベンチに置いておきたい“保険”のような存在。" },
  { number: 7, positionGroup: "FW", position: "LM", subPositions: ["RM", "LW"], firstName: "Bénie", lastName: "Traoré", displayName: "Bénie Traoré", image: "./players/traore.png", age: 25, overall: 81, preferredFoot: "右", wage: "€84,000", nationality: "コートジボワール", status: "Key Player", note: "", role: "The Spark", bio: "The main attacking trigger. Breaks lines and creates Openda's route to goal." },
  { number: 8, positionGroup: "MF", position: "CM", subPositions: ["CDM"], firstName: "Ismaël", lastName: "Koné", displayName: "Ismaël Koné", image: "./players/ismael-kone.png", age: 25, overall: 78, preferredFoot: "右", wage: "€21,500", nationality: "カナダ", status: "Squad", note: "", role: "中央の推進力", bio: "Darsenaの中盤に強度と前進力をもたらすCM。守備と攻撃の接続役として重要。" },
  { number: 9, positionGroup: "FW", position: "ST", subPositions: [], firstName: "Loïs", lastName: "Openda", displayName: "Loïs Openda", image: "./players/openda.png", age: 28, overall: 84, preferredFoot: "右", wage: "€95,000", nationality: "ベルギー", status: "Summer Signing", note: "夏加入", role: "The Finisher", bio: "The new ace who decides games. His finishing pushes Darsena into title pace." },
  { number: 11, positionGroup: "FW", position: "ST", subPositions: [], firstName: "Mërgim", lastName: "Berisha", displayName: "Mërgim Berisha", image: "./players/mergim-berisha.png", age: 29, overall: 75, preferredFoot: "右", wage: "€22,000", nationality: "ドイツ", status: "Squad", note: "", role: "ボックス内の仕事人", bio: "万能型のストライカー。派手なスピードよりも、ゴール前での判断と収まりで勝負する。" },
  { number: 12, positionGroup: "GK", position: "GK", subPositions: [], firstName: "Sam", lastName: "Karssies", displayName: "Sam Karssies", image: "./players/sam-karssies.png", age: 25, overall: 63, preferredFoot: "右", wage: "€3,000", nationality: "オランダ", status: "Summer Signing", note: "夏加入", role: "控えGK／準備の男", bio: "夏に加入したバックアップGK。出番は限られるが、長いシーズンを支えるための重要な保険。" },
  { number: 14, positionGroup: "MF", position: "CDM", subPositions: ["CB"], firstName: "Kylian", lastName: "Kaïboué", displayName: "Kylian Kaïboué", image: "./players/kylian-kaiboue.png", age: 30, overall: 75, preferredFoot: "左", wage: "€13,000", nationality: "フランス", status: "Squad", note: "", role: "The Structure", bio: "The center of balance and calm. Kaiboue is the structure Darsena stands on." },
  { number: 15, positionGroup: "DF", position: "LB", subPositions: ["LM"], firstName: "Pedro", lastName: "Silva Torrejón", displayName: "Pedro Silva Torrejón", image: "./players/pedro-silva-torrejon.png", age: 31, overall: 74, preferredFoot: "左", wage: "€12,500", nationality: "アルゼンチン", status: "Squad", note: "", role: "左足のクロッサー", bio: "左サイドから質のあるボールを供給するベテラン。守備の軽さはあるが、攻撃面では違いを作れる。" },
  { number: 16, positionGroup: "DF", position: "CB", subPositions: [], firstName: "Patric", lastName: "Pfeiffer", displayName: "Patric Pfeiffer", image: "./players/patric-pfeiffer.png", age: 28, overall: 74, preferredFoot: "右", wage: "€12,000", nationality: "ガーナ", status: "Squad", note: "", role: "制空権担当", bio: "高さとフィジカルで最終ラインを支えるCB。Darsenaの“壊れない守備”に必要な壁。" },
  { number: 20, positionGroup: "FW", position: "RW", subPositions: ["ST", "CAM"], firstName: "Vicente", lastName: "Varela", displayName: "Vicente Varela", image: "./players/vicente-varela.png", age: 21, overall: 73, preferredFoot: "右", wage: "€7,600", nationality: "スペイン", status: "Prospect", note: "", role: "若き万能アタッカー", bio: "RW、ST、CAMをこなせる21歳。攻撃の複数ポジションで起用できる便利さが魅力。" },
  { number: 21, positionGroup: "DF", position: "CB", subPositions: [], firstName: "Joshua", lastName: "Quarshie", displayName: "Joshua Quarshie", image: "./players/joshua-quarshie.png", age: 24, overall: 75, preferredFoot: "右", wage: "€12,000", nationality: "ドイツ", status: "Squad", note: "", role: "次世代の守備柱", bio: "若さとサイズを兼ね備えたCB。今後のDarsena守備陣を担う存在として期待される。" },
  { number: 24, positionGroup: "DF", position: "RB", subPositions: ["CB"], firstName: "Junnosuke", lastName: "Suzuki", displayName: "Junnosuke Suzuki", image: "./players/junnosuke-suzuki.png", age: 25, overall: 74, preferredFoot: "右", wage: "€15,000", nationality: "日本", status: "Summer Signing", note: "夏加入", role: "右サイドの規律", bio: "夏加入の日本人DF。右サイドに安定感をもたらし、状況次第ではCBとしてもチームを支える。" },
  { number: 25, positionGroup: "DF", position: "LB", subPositions: ["LM"], firstName: "Aarón", lastName: "Martín", displayName: "Aarón Martín", image: "./players/aaron-martin.png", age: 31, overall: 74, preferredFoot: "左", wage: "€18,500", nationality: "スペイン", status: "Summer Signing", note: "夏加入", role: "経験ある左の選択肢", bio: "夏に加わったスペイン人SB。即戦力として左サイドの競争を高める。" },
  { number: 27, positionGroup: "FW", position: "RW", subPositions: ["CAM", "CM", "RM"], firstName: "Matheus", lastName: "Mané", displayName: "Matheus Mané", image: "./players/matheus-mane.png", age: 20, overall: 75, preferredFoot: "右", wage: "€7,000", nationality: "イングランド", status: "Prospect", note: "", role: "攻撃の変化球", bio: "右サイド、中央、インサイドでプレーできる若手。試合にリズムの変化を加えられる存在。" },
  { number: 30, positionGroup: "MF", position: "CM", subPositions: [], firstName: "Nicholas", lastName: "Fiore", displayName: "Nicholas Fiore", image: "./players/nicholas-fiore.png", age: 19, overall: 73, preferredFoot: "右", wage: "€7,100", nationality: "イタリア", status: "Academy", note: "", role: "未来の中盤", bio: "19歳ながら試合に絡めるだけの能力を持つ若手CM。Darsenaの次世代を象徴する存在。" },
  { number: 31, positionGroup: "MF", position: "CAM", subPositions: ["CM"], firstName: "Massimo", lastName: "Bianchi", displayName: "Massimo Bianchi", image: "./players/massimo-bianchi.png", age: 18, overall: 66, preferredFoot: "右", wage: "€4,500", nationality: "イタリア", status: "Academy", note: "", role: "創造性の原石", bio: "18歳のCAM。まだ完成度は低いが、中央で違いを作れる可能性を秘めている。" },
  { number: 32, positionGroup: "DF", position: "CB", subPositions: [], firstName: "Jonathan", lastName: "Marechal", displayName: "Jonathan Marechal", image: "./players/jonathan-marechal.png", age: 18, overall: 63, preferredFoot: "右", wage: "€4,200", nationality: "フランス", status: "Academy", note: "", role: "育成枠CB", bio: "18歳の若きCB。まだ粗さはあるが、Darsenaの守備文化を吸収して成長を狙う。" },
  { number: 33, positionGroup: "FW", position: "ST", subPositions: ["LW", "RW"], firstName: "Tommaso", lastName: "Bianchi", displayName: "Tommaso Bianchi", image: "./players/tommaso-bianchi.png", age: 21, overall: 64, preferredFoot: "左", wage: "€600", nationality: "イタリア", status: "Prospect", note: "", role: "控えの若き9番", bio: "21歳の左利きFW。現状は序列下位だが、限られた出番で爪痕を残したい。" },
  { number: 35, positionGroup: "DF", position: "RB", subPositions: [], firstName: "Fabrice", lastName: "Billard", displayName: "Fabrice Billard", image: "./players/fabrice-billard.png", age: 18, overall: 60, preferredFoot: "左", wage: "€2,500", nationality: "フランス", status: "Academy Promotion", note: "夏昇格", role: "昇格組の挑戦者", bio: "夏にトップ昇格した若手RB。出場機会を得ながら、プロの強度に適応していく段階。" },
  { number: 39, positionGroup: "FW", position: "ST", subPositions: [], firstName: "Shaqueel", lastName: "van Persie", displayName: "Shaqueel van Persie", image: "./players/shaqueel-van-persie.png", age: 21, overall: 69, preferredFoot: "左", wage: "€3,000", nationality: "オランダ", status: "Prospect", note: "", role: "結果で語る若手", bio: "短い時間でもゴールに絡める若手ST。序列を上げるには、内容よりまず結果が求められる。" },
  { number: null, positionGroup: "FW", position: "ST", subPositions: [], firstName: "Emil", lastName: "Højlund", displayName: "Emil Højlund", image: "./players/emil-hojlund.png", age: 23, overall: 74, preferredFoot: "右", wage: "€1,300", nationality: "デンマーク", status: "On Loan", note: "レンタル移籍 / 旧背番号9", role: "武者修行中のCF", bio: "ポストプレーと連係に可能性を持つストライカー。レンタル先で得点感覚と自信を磨きたい。" },
  { number: null, positionGroup: "MF", position: "CAM", subPositions: [], firstName: "Jan", lastName: "Lehmann", displayName: "Jan Lehmann", image: "./players/jan-lehmann.png", age: 20, overall: 66, preferredFoot: "左", wage: "€450", nationality: "スイス", status: "On Loan", note: "レンタル移籍 / 旧背番号29", role: "育成中の司令塔", bio: "若きCAM。実戦経験を積み、Darsenaに戻る価値を証明するレンタル期間になる。" },
];
...
function SiteHeader({ activePage, onPageChange, onHomeClick }) {
  return (
    <header className="border-b border-white/10 bg-darsena-navy/95 px-4 py-4 backdrop-blur sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        <button type="button" onClick={onHomeClick} className="flex items-center gap-3 text-left transition hover:opacity-95">
        ...
        <nav className="flex items-center border border-white/10 bg-black/25">
          {["Home", "About", "Squad"].map((page) => (
            <button
              key={page}
              type="button"
              onClick={() => onPageChange(page)}
              className={`min-h-10 px-4 text-xs font-black uppercase tracking-[.22em] transition ${
